...
urlpatterns = [
    ...
    path('team/delete/<int:pk>', views.TeamView.as_view(), name='teamdelete'),
    ...
    path('likecategory/delete/<int:pk>', views.LikeCategoryView.as_view(), name='likecategorydel'),
    ...
    path('notice/save', views.NoticeImageSaveView.as_view(), name='noticeimg')
]
